...
'''
    ...
    log.info "--strains              String                Name of folder to output results"    
    ...
    log.info "--annotation_reference STRING               Wormbase build for SnpEff annotations"
...
'''
    ...
    log.info "Region file.                        = ${params.interval_bed}" 
